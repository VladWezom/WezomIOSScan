...
final class EditImageViewController: UIViewController {
    ...
    var controller: WeScan2.EditImageViewController!
    ...
    private func setupView() {
        controller = WeScan2.EditImageViewController(image: captureImage, quad: quad, strokeColor: UIColor(red: (69.0 / 255.0), green: (194.0 / 255.0), blue: (177.0 / 255.0), alpha: 1.0).cgColor)
